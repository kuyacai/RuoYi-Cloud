 ...
 */
@Service
public class ProductDiscountConfigServiceImpl extends BaseServiceImpl<ProductDiscountConfigMapper, ProductDiscountConfig> implements IProductDiscountConfigService 
{
