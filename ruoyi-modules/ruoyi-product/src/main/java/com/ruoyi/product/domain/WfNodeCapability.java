...
import com.ruoyi.product.enums.AuditStatus;
import com.ruoyi.product.enums.CapabilityScope;
import com.ruoyi.product.enums.HandlerType;
import com.ruoyi.product.enums.ManualStatus;
import com.ruoyi.product.enums.YesNoUnknown;
...
public class WfNodeCapability extends ProductBaseEntity {
    ...
    /**
     * 能力唯一物理ID (如: capability_id:fingerprint)
     */
    ...
    @TableField("is_long_running")
    private YesNoUnknown longRunningStatus;

    @TableField("is_latest")
    private YesNoUnknown latestStatus;
